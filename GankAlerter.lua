...
function GankAlerter:Draw()
	...
	for i, enemy in pairs(heroeslist) do
		...
		if newdistance < 3000 and enemy.visible then
			...
			if (olddistance[enemy.charName] and olddistance[enemy.charName] > 3000 and oldvisible[enemy.charName] == false) or (oldvisible[enemy.charName] and GetTickCount() - oldvisible[enemy.charName]  > 3000) then
